...
public class ViginerDecryptor extends Decryptor {
	private String text;
	private int keyWordLength;
	private String keyWord = "";	
	
	private Map<String, VariantNode> variantGroup = new LinkedHashMap<>();
	...
	public ViginerDecryptor(String text) {
		this.text = text;
	...
	private void computVariantGroup() {
		for (int i = 0; i < keyWordLength; i++) {
			...
			ArrayList<VariantNode> variantList = new ArrayList<>();
	...
	private String[] computBestVariant() {
		...
		int ii = 0;
		for (Map.Entry<String, VariantNode> entry: variantGroup.entrySet()) {
	...
	private void computeKeyWord() {
		for (Map.Entry<String, VariantNode> entry: this.variantGroup.entrySet()) {
